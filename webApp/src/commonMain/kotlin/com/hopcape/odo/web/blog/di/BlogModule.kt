 ...
 * being sample data.
 *
 * The three `single` lines below name implementations; everything above them
 * asks for the interface. Pointing them at Supabase-backed classes is the whole
 * integration on this side — no ViewModel, no screen and no test has to move.
 *
...
val blogModule: Module = module {
    ...
    single<AuthRepository> { SampleAuthRepository() }
