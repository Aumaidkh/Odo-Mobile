...
// ─────────────────────────────────────────────────────────────
// RetryPolicy — exponential backoff bounds for redelivery of spans
// whose export failed. Jitter-free for simplicity; add jitter in
// production to avoid a thundering herd. Mirrors the analytics
// module's RetryPolicy.
// ─────────────────────────────────────────────────────────────
internal class RetryPolicy(
    ...
    /** Whether a span has exhausted its retries and should be dead-lettered. */
