    ...
    get() {
        ...
        _IcGearFilled = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcToRelative(1.464f, 1.464f, 0f, isMoreThanHalf = false, isPositiveArc = true, -2.105f, 0.872f)
                ...
                close()
                moveTo(8f, 10.93f)
                arcToRelative(2.929f, 2.929f, 0f, isMoreThanHalf = true, isPositiveArc = true, 0f, -5.86f)
                arcToRelative(2.929f, 2.929f, 0f, isMoreThanHalf = false, isPositiveArc = true, 0f, 5.858f)
                close()
            }
        }.build()
