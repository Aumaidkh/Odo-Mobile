...
val IcBellOutlined: ImageVector
    get() {
        if (_IcBellOutlined != null) {
            return _IcBellOutlined!!
        }
        _IcBellOutlined = ImageVector.Builder(
            name = "IcBellOutlined",
            defaultWidth = 16.dp,
            defaultHeight = 16.dp,
            viewportWidth = 16f,
            ...
            path(fill = SolidColor(Color.Black)) {
                ...
                arcTo(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, 4f, 6f)
                ...
                arcToRelative(4f, 4f, 0f, isMoreThanHalf = false, isPositiveArc = false, -3.203f, -3.92f)
                close()
                moveTo(14.22f, 12f)
                ...
                arcToRelative(1f, 1f, 0f, isMoreThanHalf = true, isPositiveArc = true, 1.99f, 0f)
                arcTo(5f, 5f, 0f, isMoreThanHalf = false, isPositiveArc = true, 13f, 6f)
...
private var _IcBellOutlined: ImageVector? = null
