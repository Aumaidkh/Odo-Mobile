...
internal val TeslaLightColorScheme = lightColorScheme(
    ...
    // The container family backs menus, sheets and dialogs; unmapped they resolve
    // to Material's tonal defaults, which read as off-brand lavender in light mode.
    surfaceContainerLowest = TeslaPalette.LightSurface,
    surfaceContainerLow = TeslaPalette.LightSurface,
    surfaceContainer = TeslaPalette.LightSurface,
    surfaceContainerHigh = TeslaPalette.LightSurfaceRaised,
    surfaceContainerHighest = TeslaPalette.LightSurfaceRaised,
...
internal val TeslaDarkColorScheme = darkColorScheme(
    ...
    surfaceContainerLowest = TeslaPalette.DarkSurface,
    surfaceContainerLow = TeslaPalette.DarkSurface,
    surfaceContainer = TeslaPalette.DarkSurface,
    surfaceContainerHigh = TeslaPalette.DarkSurfaceRaised,
    surfaceContainerHighest = TeslaPalette.DarkSurfaceRaised,
