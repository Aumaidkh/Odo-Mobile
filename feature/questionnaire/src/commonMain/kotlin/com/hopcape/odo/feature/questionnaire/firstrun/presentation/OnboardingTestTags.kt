 ...
 * passing over an empty label. Fields are the exception because an odometer drum and a
 * picker that opens a sheet have no stable text to aim at — the value they hold is exactly
 * what the test is about to change.
 */
