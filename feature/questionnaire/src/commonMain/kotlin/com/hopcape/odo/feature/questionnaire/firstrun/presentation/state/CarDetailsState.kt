...
/**
 * The car step's answers — four pickers keyed to the catalog, because the fairness
 * benchmarks are keyed on make/model/year/fuel. Make and model also accept "not listed"
 * free text, which opts that car out of benchmarking until enough other owners report the
 * same one.
 *
