...
kotlin {
    ...
    androidLibrary {
        namespace = "com.hopcape.odo.feature.reminders"
    }
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // The notification scheduler the write use cases ask for a refresh from — the
            // owner's own reminders are delivered by the device, not by a server.
            ...
            // APM spans around the writes the ViewModels drive — the feature's telemetry
            // facade owns the plumbing.
...
compose.resources {
    ...
    packageOfResClass = "com.hopcape.odo.feature.reminders.resources"
