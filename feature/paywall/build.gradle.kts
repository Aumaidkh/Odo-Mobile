...
kotlin {
    ...
    androidLibrary {
        namespace = "com.hopcape.odo.feature.paywall"
    }
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // rememberStoreRater — the Play listing link shown when Play will not sell here.
...
compose.resources {
    ...
    packageOfResClass = "com.hopcape.odo.feature.paywall.resources"
