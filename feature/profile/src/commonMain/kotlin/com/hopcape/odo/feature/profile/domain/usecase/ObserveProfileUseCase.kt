 ...
 *
 * Entitlement and session are read per emission rather than observed, because neither can
 * change while the screen is open — a subscription is bought outside the app and there is
 * no sign-in flow that returns here. Both ports grow a stream when that stops being true,
