...
kotlin {
    ...
    androidLibrary {
        namespace = "com.hopcape.odo.feature.documentvault"
    }
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // APM spans around the file copy and the DB writes the ViewModels drive —
...
compose.resources {
    ...
    packageOfResClass = "com.hopcape.odo.feature.documentvault.resources"
