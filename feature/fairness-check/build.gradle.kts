...
kotlin {
    ...
    androidLibrary {
        namespace = "com.hopcape.odo.feature.fairnesscheck"
    }
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // APM spans around the benchmark lookup the ViewModel drives — the feature's
...
compose.resources {
    ...
    packageOfResClass = "com.hopcape.odo.feature.fairnesscheck.resources"
